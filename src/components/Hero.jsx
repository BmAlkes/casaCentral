    ...
    <section className="max-padd-container pt-[99px]">
      <div className="max-padd-container bg-hero bg-center bg-cover bg-no-repeat h-[655px] w-full rounded-3xl">
        <div className="relative top-32 xs:top-52">
          <span className="medium-18">Welcome to Casa Central</span>
          <h1 className="h1 capitalize max-w-[40rem]">
            Discover Expetional Homes With Casa Central{" "}
          </h1>
          <p className="my-10 max-w-[33rem]">
          "Find your dream home with Casa Central. We offer a curated selection of exceptional properties designed to fit your lifestyle. Whether you're looking for a modern city apartment or a luxurious family home, we are here to guide you every step of the way. Explore our listings and take advantage of exclusive deals today!"
          </p>
          {/* button */}
